...
class CommonRules {
  public static commonSchema() {
    return {
      technology : schema.string({ trim: true }, [rules.unique({ table: 'technologies', column: 'technology' })]),
      value : schema.string({ trim: true }, [rules.unique({ table: 'technologies', column: 'value' })]),
    }
  }
